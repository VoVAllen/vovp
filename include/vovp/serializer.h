 ...
 * \brief Serializer extension to support VOVP data types
 *  Include this file to enable serialization of DLDataType, DLContext
 */
#ifndef VOVP_RUNTIME_SERIALIZER_H_
#define VOVP_RUNTIME_SERIALIZER_H_
...
#endif  // VOVP_RUNTIME_SERIALIZER_H_
