 ...
 */
#ifndef VOVP_RUNTIME_WORKSPACE_POOL_H_
#define VOVP_RUNTIME_WORKSPACE_POOL_H_
...
class WorkspacePool {
 public:
   ...
   */
  void* AllocWorkspace(VOVPContext ctx, size_t size);
  /*!
   ...
   */
  void FreeWorkspace(VOVPContext ctx, void* ptr);
...
#endif  // VOVP_RUNTIME_WORKSPACE_POOL_H_
